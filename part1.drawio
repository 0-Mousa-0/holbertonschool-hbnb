  ...
  <diagram name="Page-1" id="m4TTUJhk0F_wm50ro0c3">
    <mxGraphModel dx="1042" dy="1726" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="850" pageHeight="1100" background="none" math="0" shadow="1">
      <root>
        ...
        <mxCell id="ytkhowvEdn_do_f2hXwO-36" connectable="0" parent="ytkhowvEdn_do_f2hXwO-35" style="edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];labelBackgroundColor=none;fontColor=#FFFFFF;textShadow=1;" value="Uses Facade Interface" vertex="1">
        ...
        <mxCell id="ytkhowvEdn_do_f2hXwO-38" connectable="0" parent="ytkhowvEdn_do_f2hXwO-37" style="edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];labelBackgroundColor=none;fontColor=#FFFFFF;textShadow=1;" value="Uses Persistence Layer" vertex="1">
